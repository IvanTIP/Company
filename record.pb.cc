...
const ::uint32_t TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::Record, _impl_.activitytype_),
...
Record::Record(const Record& from)
  ...
  if ((from._impl_._has_bits_[0] & 0x00000004u) != 0) {
    _this->_impl_.activitytype_.Set(from._internal_activitytype(), _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.year_, &from._impl_.year_,
    static_cast<::size_t>(reinterpret_cast<char*>(&_impl_.foreigneconomicactivity_) -
    reinterpret_cast<char*>(&_impl_.year_)) + sizeof(_impl_.foreigneconomicactivity_));
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 34)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Record.activityType");
          #endif  // !NDEBUG
        } else {
          goto handle_unusual;
        }
...
void Record::InternalSwap(Record* other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.activitytype_, lhs_arena,
